...
download ccx_2.9.pdf http://www.dhondt.de/ccx_2.9.pdf
download cgx_2.9.pdf http://www.dhondt.de/cgx_2.9.pdf
download cgx_2.9.exa.tar.bz2 http://www.dhondt.de/cgx_2.9.exa.tar.bz2
...
cp -p $CALCULIX_HOME/downloads/ccx_2.9.pdf $PACKAGE_DIR/doc
cp -p $CALCULIX_HOME/downloads/cgx_2.9.pdf $PACKAGE_DIR/doc
cp -p $CALCULIX_HOME/downloads/cgx_2.9.exa.tar.bz2 $PACKAGE_DIR/doc

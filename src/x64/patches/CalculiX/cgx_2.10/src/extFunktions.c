...
void help( void )
{
  ...
  printf ("   'swep' <set> <new_set> ['scal' <fx> <fy> <fz> [<pnt>|<div>]]|['tra' <x> <y> <z> <div>]|['rad' [<p1> <p2> <value> <div>]|['x'|'y'|'z' <value> <div>]|[<p1> 'x'|'y'|'z' <value> <div>]|['p'<PNT> <dr> <div>]]|['rot' [<p1> <p2> <value> <div>]|['x'|'y'|'z' <value> <div>]|[<p1> 'x'|'y'|'z' <value> <div>]]|['mir' [<p1> <p2> <div>]|['x'|'y'|'z' <div>]|[<p1> 'x'|'y'|'z' <div>]]|['nor' <value> <div>] [append]\n");

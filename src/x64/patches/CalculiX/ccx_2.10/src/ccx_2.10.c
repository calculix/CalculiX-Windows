...
// Need to comment this out to avoid conflict with _set_output_format definitions.
// Output is in correct format because we are still using the technique used in v 2.5.
//#ifdef __WIN32
